...
class GroupsCommandTest extends DirectorySyncConsoleIntegrationTestCase
{
    ...
    public function testDirectoryGroupsCommand_DryRun(): void
    {
        ...
        $this->assertOutputContains('<success>[success] The group Administration was successfully added to passly.</success>');
        $this->assertOutputContains('<success>[success] The group Managers was successfully added to passly.</success>');
        $this->assertOutputContains('<success>[success] The group C Level was successfully added to passly.</success>');
        $this->assertOutputContains('<success>[success] The group Developers was successfully added to passly.</success>');
