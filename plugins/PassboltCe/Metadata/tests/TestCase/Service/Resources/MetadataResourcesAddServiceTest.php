...
class MetadataResourcesAddServiceTest extends AppTestCaseV5
{
    ...
    public function testMetadataResourceAddService_Error_ValidationResourceTypeNotV5()
    {
        ...
        try {
            ...
            $this->assertSame(
                'The resource type should be one of the following: v5-password-string, v5-default, v5-totp-standalone, v5-default-with-totp, v5-custom-fields, v5-note, v5-pin-code, v5-passkey.',
